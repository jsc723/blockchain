...
class Transaction:
    ...
    def create_input(self, sender_wallet, output):
        ...
        Also sign the transaction and include the sender's
    ...
    def from_json(transaction_json):
        """
        Deserialize a transaction's json to an instance
        """
    ...
    def is_valid_transaction(transaction):
        ...
        """
        if transaction.input == MINEING_REWARD_INPUT:
            if list(transaction.output.values()) != [MINEING_REWARD]:
    ...
    def reward_transaction(miner_wallet):
        ...
        """
        output = {}
        output[miner_wallet.address] = MINEING_REWARD

        return Transaction(input=MINEING_REWARD_INPUT, output=output)
