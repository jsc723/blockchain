...
from backend.config import MINEING_REWARD_INPUT
from backend.wallet.wallet import Wallet

class Blockchain:
    '''
    list of blocks - data sets of transcations
    '''
    def __init__(self):
    ...
    def is_valid_chain(chain):
        ...
        Validate the incoming chain.
            - the chain starts with genesis block
                ...
                if transaction.input == MINEING_REWARD_INPUT:
                    if has_mining_reward:
                        raise Exception(
                            ...
                            f'Chech block with hash: {block.hash}'
                        )
    ...
    def from_json(chain_json):
        ...
        blockchain.chain = list(map(Block.from_json, chain_json))
        return blockchain
